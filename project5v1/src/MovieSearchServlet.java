...
Context initCtx = new InitialContext();
    ...
    {
    	long startTimeTS = 0, startTimeTJ = 0, endTimeTS = 0, endTimeTJ = 0;
    	long elapsedTimeTS = 0, elapsedTimeTJ = 0;
    	...
    	String cvsFilePath = contextPath + "Time.csv";
    	...
    	try
    	{
    		...
    		// Add header to csv if file does not exist
	    	if (fileExist == false)
	    	{ 
	    		String[] header = { "Title", "TS", "TJ" }; 
		        writer.writeNext(header);
	    	}
	    	
	        // Add data
	    	String [] data = {urlTitle, Long.toString(elapsedTimeTS), Long.toString(elapsedTimeTJ)};
