...
function handleResult(resultData) {
    ...
    // Concatenate the html tags with resultData jsonObject to create table rows
        ...
        let movieArray = resultData[0]["movie_list"].split(",");
        rowHTML +="<th>"  + '<a href="single-movie.html?title=' + movieArray[0] + '">' + movieArray[0] + '</a>';
       
        for(let i = 1; i < movieArray.length; i++){
        rowHTML += ', <a href="single-movie.html?title=' + movieArray[i] + '">' + movieArray[i] + '</a>';
        }
        rowHTML += "</th>";
        rowHTML += "</tr>";
